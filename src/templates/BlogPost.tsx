...
const Template = (props: any) => {
  const image = getPathImagesBlog(props.data.markdownRemark.frontmatter.featured_image.publicURL);
  return (
    <ThemeProvider theme={theme}>
      <div>
        <Helmet
          ...
          meta={[
            { name: "description", content: props.data.markdownRemark.frontmatter.description },
            {
              name: "keywords",
